 ...
 * @author barbo
 */
@WebServlet(name = "SvDonaciones", urlPatterns = {"/SvDonaciones"})
public class SvDonaciones extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Donaciones donacion = new Donaciones(nombre, identificacion, monto);

        HttpSession session = request.getSession();
        List<Donaciones> listaDonaciones = (List<Donaciones>) session.getAttribute("listaDonaciones");
        if (listaDonaciones == null) {
            listaDonaciones = new ArrayList<>();
        }
        listaDonaciones.add(donacion);
        session.setAttribute("listaDonaciones", listaDonaciones);
